...
I am organizing a __quantum error correction seminar__ from Spring 2024 to Winter 2025. The main goal is to understand __why a quantum computer can be built__. Very Very recently, I am convinced that quantum computer can be built and maybe within a decade.
